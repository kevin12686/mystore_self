...
urlpatterns = [
    ...
    url(r'^dashboard/products$', views.ProductList.as_view(template_name='estore/dashboard_product_list.html',
    ...
    url(r'^dashboard/products/(?P<pk>\d+)/delete$', views.ProductDelete.as_view(), name='dashboard_product_delete'),
    ...
    url(r'^dashboard/users/(?P<pk>\d+)/removefromstaff$', views.UserRemoveFromStaff.as_view(),
        name='dashboard_user_removefromstaff'),
]
